...
\begin{frame}
  ...
  % \begin{figure}
  %   \centering
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_atm_tf_far.png}
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_atm_tf_close.png}
  % \end{figure}
\end{frame}
...
\begin{frame}
  ...
  % \begin{figure}
  %   \centering
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_50psi_tf_far.png}
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_50psi_tf_close.png}
  % \end{figure}
\end{frame}
...
\begin{frame}
  ...
  % \begin{figure}
  %   \centering
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_100psi_tf_far.png}
  %   \includegraphics[width=0.7\textwidth]{tf_plots/700_100psi_tf_close.png}
  % \end{figure}
\end{frame}
