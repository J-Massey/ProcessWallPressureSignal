...
\begin{frame}
  ...
  \begin{equation}
      \centering
      |H_{\textrm{cal}}| = |H_{\textrm{measured}}| \times S(psig)
  \end{equation}
  \begin{equation}
      \centering
      20\log S = c_0 +a 20\log f + b 20\log \frac{\rho}{\rho_{\textrm{ref}}}+ \frac{f}{f_{\textrm{ref}}}
  \end{equation}
  \begin{itemize}
    \centering
...
\begin{frame}
  ...
  \begin{figure}
      \centering
      \includegraphics[width=0.85\textwidth]{tau_w/speed_vs_Tplus_raw_absG12_0.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
      \centering
      \includegraphics[width=0.85\textwidth]{tau_w/speed_vs_Tplus_raw_absG12_50.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
      \centering
      \includegraphics[width=0.85\textwidth]{tau_w/speed_vs_Tplus_raw_absG12_100.png}
  \end{figure}
\end{frame}
