...
\begin{frame}
    ...
    \begin{columns}[c] % vertically centered
        \column{0.5\textwidth}
            \centering
            \includegraphics[width=0.6\linewidth]{../figures/cali_09/PH-NKD/H_atm_npsg32768.png}
        ...
        \column{0.5\textwidth}
            \centering
            \includegraphics[width=0.6\linewidth]{../figures/cali_09/PH-NKD/gamma2_ph_atm_npsg32768.png}
            \includegraphics[width=0.6\linewidth]{../figures/cali_09/PH-NKD/gamma2_ph_atm_npsg16384.png}
            \includegraphics[width=0.6\linewidth]{../figures/cali_09/PH-NKD/gamma2_ph_atm_npsg4096.png}
    \end{columns}
\end{frame}
