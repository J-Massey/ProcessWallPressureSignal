...
\begin{frame}
    \frametitle{Pre-multiplied raw spectra at $N=2^{10}, 2^{12}, 2^{14}$}
    \begin{columns}[c] % vertically centered
        \column{0.5\textwidth}
            \centering
            Pinhole mic.
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_ph_atm_npsg32768.png}
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_ph_atm_npsg16384.png}
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_ph_atm_npsg4096.png}

        \column{0.5\textwidth}
            \centering
            Nose cone mic.
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_nc_atm_npsg32768.png}
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_nc_atm_npsg16384.png}
            \includegraphics[width=\linewidth]{../figures/cali_09/flow/raw/Pyy_nc_atm_npsg4096.png}
\end{frame}
