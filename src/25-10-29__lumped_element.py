    ...
    *,
    ...
    def _load_target(L: str):
        ...
        with h5py.File(path, "r") as hf:
            ...
            s = np.asarray(hf["scaling_ratio"][:], float)
...
def plot_target_calib_modeled(
    ...
    *,
    ...
    """
    Plot target (required |H|), measured calibration |H_cal|, and modeled |H_cal| * S(f,ρ) together.
    ...
    The modeled curve uses the fitted scale S(f,ρ) from fit_speaker_scaling_from_files(...).
