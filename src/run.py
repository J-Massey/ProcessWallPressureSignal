...
from processing import (compute_psd, propagate_error,
                        ...
                        notch_filter)
from noise_rejection import wiener_filter_timeseries, compute_coherence_psd
...
def noise_rejection():
    ...
    plot_filtered_diff(spec_w, phi_filt_w, phi_filt_fs,
                       os.path.join(OUTPUT_DIR, "difference.png"))
    # analyze coherence
    compute_coherence_psd(p_fs, p_w, SAMPLE_RATE)
    wiener_filter_timeseries(p_fs, p_w, SAMPLE_RATE)
