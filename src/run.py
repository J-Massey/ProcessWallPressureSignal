...
def inverse_filter(y, fs, f, H, coh2, f_band=None, pad=0):
    """
...
def main(idx):
    ...
    plot_corrected_trace(t, ref, trt, trt_corr, os.path.join(OUTPUT_DIR, f"trace_{idx}.png"))
